            ...
            <div class="card">
                <div class="card-body row">
                        ...
                        <table class="table">
                            <tr>
                                <td>
                                    ...
                                    <strong>{{$reservacion->order_nr}}</strong>
                                </td>
                                <td>
                                    <h5>Metodo de pago:</h5>
                                    <strong>{{$reservacion->ModoPago}}</strong>
                                </td>
                                <td>
                                    <h5>Fecha reserva:</h5>
                                    <strong>{{$reservacion->Fechareserva}}</strong>
                                </td>
                                <td>
                                    <h5>Monto cobrado:</h5>
                                    <strong>{{$reservacion->Monto}} {{$reservacion->Moneda}}</strong>
                                    <br>
                                    <strong>Cantidad turistas : {{$reservacion->CantidadTuristas}}</strong>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <h5>Datos comprador:</h4>
                                        <br>
                                        <strong>{{$reservacion->DatosComprador}}</strong>
                                </td>
                                <td colspan="2">
                                    <h5>Estaodo:</h4>
                                        <h2 style="color:red">{{$reservacion->status}}</strong>
                                </td>
                    ...
                    <div class="col-sm-4" style="text-align:center">
                        ...
                        <br>
                        @foreach ($reservacion->getComprador as $comprador)
                        <div>
                    ...
                    <div class="col-sm-4" style="text-align:center">
                        <h4>Datos comprador</h4>
                        <br>
                        @foreach ($reservacion->getGuia as $guia)
                        <div>
                    ...
                    <div class="col-sm-4" >
                        <h4>Datos Tour</h4>
                        @foreach ($reservacion->getTour as $tour)
                        <div>
                            <p>Nombre tour</p>
